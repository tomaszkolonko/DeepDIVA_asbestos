...
\midrule
FINAL (regular)                & 79.62\%  $\pm$ 0.9465 &   86.93\% $\pm$ 0.7757   & +7.31\%    \\
FINAL (randomNine)            & 83.39\% $\pm$ 0.9526 &  87.92\% $\pm$ 1.1293 & +4.53\%    \\
\midrule
increased accuracy			& +3.77\%			& +1.00\% & - \\
\bottomrule
\end{tabular}}
...
The forward pass consists of doing first the new convolution with batch normalization, then passing the output through a ReLU and then feeding it to the previously first convolution layer that expects the original size. Table \ref{resnet18-different-input} summarizes the results.
...
\section{Combinations of fewer filters, reduced dataset and data augmentation}

At the end of this chapter, I would like to try out some of the combinations that seem promising or at least seem logical to persue. For example, having the ResNet18 architecture with only 16 or 2 filters per layer reduces the complexity of the network drastically. This could be combined with FiveCrop and NineCrop and used on a cleaned and balanced dataset. Table \ref{tbl:resnet18-combinations} shows a summary of these combinations.
...
\resizebox{0.79\textwidth}{!}{%
\begin{tabular}{@{}rrrr@{}}
\toprule & data augmentation & dataset & accuracy \\
\midrule
ResNet18_16 & fivecrop & FINAL_CH & 73.20\%  $\pm$ 0.9526 \\
ResNet18_16 & fivecrop & FINAL_CH_B & 73.42\% $\pm$ 1.7788 \\
ResNet18_16 & fivecrop & FINAL_EXTENDED	& 74.52\% $\pm$ 0.6265 \\
\midrule
ResNet18_16 & ninecrop & FINAL_CH & 75.74\% $\pm$ 0.7177 \\
ResNet18_16 & ninecrop & FINAL_CH_B	 & 76.08\% $\pm$ 1.3563 \\
ResNet18_16 & ninecrop & FINAL_EXTENDED & 72.53 \% $\pm$ 3.3917  \\
\midrule
ResNet18_2 & fivecrop & FINAL_CH & 73.20\%  $\pm$ 0.9526 \\
ResNet18_2 & fivecrop & FINAL_CH_B & 73.42\% $\pm$ 1.7788 \\
ResNet18_2 & fivecrop & FINAL_EXTENDED	& 74.52\% $\pm$ 0.6265 \\
\midrule
ResNet18_2 & ninecrop & FINAL_CH & 75.74\% $\pm$ 0.7177 \\
ResNet18_2 & ninecrop & FINAL_CH_B	 & 76.08\% $\pm$ 1.3563 \\
ResNet18_2 & ninecrop & FINAL_EXTENDED & 72.53 \% $\pm$ 3.3917  \\
\bottomrule
\end{tabular}}
\label{tbl:resnet18-combinations}
\end{table}

Talk about the summary

The same things could be checked for the VGG13 architecture. 

--------\\

Run ResNet18 with 16 filters and 2 filters and with FiveCrop and NineCrop and with 2 data set variations

Run VGG13 with "G" or "D" filter scheme and 16 units in the fully connected layer and with 2 data set variations py

This part is running now and will mostly finish by tomorrow\\
