\chapter{Evaluation of other Techniques}
...
Re-optimizing the hyperparameters with SigOpt yielded small but very relevant improvements as seen in Table~\ref{tbl:vgg13_f_fc_optimized}. With the new hyper parameter values VGG13\_16\_g outperforms the original model at a reduced complexity by 99.94\%. The VGG13\_16\_d model performs slightly less then the original model at a reduced  complexity by over 99.99\%. \\
...
\midrule
FINAL (regular 224)     	& 79.62  $\pm$ 0.95 & 86.93\% $\pm$ 0.78     \\
