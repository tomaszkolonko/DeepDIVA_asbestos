...
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn-pre/7-Cam-Grayscale.png}
}
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn-pre/7-Cam-Heatmap.png}
}
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn-pre/7-Cam-Image.png}
}

\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn-pre/31-Cam-Grayscale.png}
}
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn-pre/31-Cam-Heatmap.png}
}
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn-pre/31-Cam-Image.png}
}
...
\caption{Grad-Cam and heatmap visualizations are shown for the pre-trained architectures for layers 3 and 31}
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn/7-Cam-Grayscale.png}
}
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn/7-Cam-Heatmap.png}
}
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn/7-Cam-Image.png}
}


\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn/31-Cam-Grayscale.png}
}
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn/31-Cam-Heatmap.png}
}
\subfigure{
\includegraphics[width=.31\textwidth]{images/chapter5/vgg13-bn/31-Cam-Image.png}
}
