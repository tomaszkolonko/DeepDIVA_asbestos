...
All implementation is made publicly available for reference and further research. It can be found under the following GitHub link: https://github.com/tomaszkolonko/DeepDIVA\_asbestos.
...
\begin{figure}[H]
\centering
\caption{Each line represents one convolution layer in the VGG13\_bn architecture in ascending order from a \textbf{pre-trained model}. This figure shows the \textbf{first 3 convolution layer visualizations}, from which 4 interesting images were selected.}
...
\begin{figure}[H]
\centering
\caption{Each line represents one convolution layer in the VGG13\_bn architecture is ascending order from a \textbf{pre-trained model}. This Figure shows \textbf{the last 3 convolution layer visualizations}, from which 4 interesting images were selected.}
