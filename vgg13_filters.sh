...
#python ./template/RunMe.py --runner-class image_classification \
#    --dataset-folder /home/thomas.kolonko/FINAL/ \
#    --model-name vgg13_bn_d --epochs 50 --experiment-name vgg13_bn_d_16_optimized \
#    --output-folder /home/thomas.kolonko/f_vgg13_d_16_optimized --ignoregit --lr 0.077457 \
...
python ./template/RunMe.py --runner-class image_classification \
    --dataset-folder /home/thomas.kolonko/FINAL/ \
    --model-name vgg13_bn_g --epochs 50 --experiment-name vgg13_bn_g_16_optimized \
    --output-folder /home/thomas.kolonko/f_vgg13_g_16_optimized --ignoregit --lr 0.1 \
