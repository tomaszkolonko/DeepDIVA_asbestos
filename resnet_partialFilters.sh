...
#    --model-name resnet_thirtytwo --epochs 50 --experiment-name tz_asbestos_resnet18 \
#    --output-folder /home/thomas.kolonko/f_partfilt_32_output_asbestos_resnet18 --ignoregit \
...
#python ./template/RunMe.py --runner-class image_classification \
#    --dataset-folder /home/thomas.kolonko/FINAL/ \
#    --model-name resnet_four --epochs 50 --experiment-name tz_asbestos_resnet18 \
...
#    --model-name resnet_thirtytwo --epochs 50 --experiment-name tz_asbestos_resnet18 \
#    --output-folder /home/thomas.kolonko/fex_partfilt_32_output_asbestos_resnet18 --ignoregit \
#    --lr 0.033678 --momentum 0.952630 --weight-decay 0.007518 --decay-lr 20
#
## ResNet18
#python ./template/RunMe.py --runner-class image_classification \
